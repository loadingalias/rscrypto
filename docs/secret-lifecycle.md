...
| ML-DSA private work | Expanded keys, transformed polynomials, seeds, randomness, message representatives, SHAKE state, rejected candidates, and Serde staging use zeroizing owners. Ordinary decode and message hashing fill existing owners in place. Prepared-owner moves and full target qualification remain open; see [ML-DSA](mldsa.md). |
