...
| | Before (`p384` 0.13) | After (`rscrypto` 0.4.0) |
|---|---|---|
| Cargo dep | `p384 = { version = "0.13", features = ["ecdsa"] }` | `rscrypto = { version = "0.4.0", default-features = false, features = ["ecdsa-p384"] }` |
...
# After
rscrypto = { version = "0.4.0", default-features = false, features = ["ecdsa-p384"] }
```
