...
| | Before (`chacha20poly1305` 0.10.x) | After (`rscrypto` 0.3.1) |
|---|---|---|
| Cargo dep | `chacha20poly1305 = "0.10"` | `rscrypto = { version = "0.3.1", features = ["chacha20poly1305", "xchacha20poly1305"] }` |
...
# After
[dependencies]
rscrypto = { version = "0.3.1", features = ["chacha20poly1305", "xchacha20poly1305"] }
```
