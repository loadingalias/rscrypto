...
| ML-DSA-44/65/87 | All 615 pinned NIST ACVP cases; RustCrypto 0.1.1 differentials; context, encoding, entropy, and prehash-domain rejection tests | [Provenance](../testdata/mldsa/acvp/README.md); successful sigGen vectors close positive prehash cases absent from the sigVer corpus. Timing and resource qualification remain open. |
