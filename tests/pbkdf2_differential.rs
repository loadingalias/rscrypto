...
#[test]
fn pbkdf2_sha256_array_wrapper_matches_rfc7914_vector_1() {
  let expected = [
    ...
    0x11, 0x20, 0x41, 0xd3, 0xa1, 0x97, 0x83,
  ];
  let actual = Pbkdf2Sha256::derive_key_array_primitive::<64>(b"passwd", b"salt", 1)
