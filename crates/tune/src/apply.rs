...
fn crc32_entry(kind_ident: &str, ieee: &AlgorithmResult, crc32c: &AlgorithmResult) -> String {
  ...
  format!(
    "  // {kind_ident}: generated by rscrypto-tune\n  (TuneKind::{kind_ident}, Crc32TunedDefaults {{\n    crc32:  \
     Crc32VariantTunedDefaults {{ streams: {crc32_streams}, portable_to_hwcrc: {}, hwcrc_to_fusion: {}, \
     fusion_to_avx512: {}, fusion_to_vpclmul: {}, min_bytes_per_lane: {} }},\n    crc32c: Crc32VariantTunedDefaults \
     {{ streams: {crc32c_streams}, portable_to_hwcrc: {}, hwcrc_to_fusion: {}, fusion_to_avx512: {}, \
     fusion_to_vpclmul: {}, min_bytes_per_lane: {} }},\n  }}),\n",
  ...
  let entry = {
    ...
    format!(
      "  // {kind_ident}: generated by rscrypto-tune\n  (TuneKind::{kind_ident}, Crc64TunedDefaults {{\n    xz:   \
       ...
       min_bytes_per_lane: {} }},\n    nvme: Crc64VariantTunedDefaults {{ streams: {nvme_streams}, portable_to_clmul: \
       {}, pclmul_to_vpclmul: {}, min_bytes_per_lane: {} }},\n  }}),\n",
