//! PCLMULQDQ/PMULL folding constants for CRC-64 (XZ + NVME).
//!
//! This module generates the constant set needed by the classic Intel/TiKV
...
//! - `K_n = bit_reverse(x^n mod (x^64 ⊕ NORMAL))`
//! - `MU = POLY⁻¹ mod x^64` (the multiplicative inverse in GF(2)[x]/(x^64))
//!
//! References:
...
// ─────────────────────────────────────────────────────────────────────────────
// Pre-computed constant sets for the polynomials used by this crate.
