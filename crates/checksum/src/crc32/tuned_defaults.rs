...
pub const CRC32_TUNED_DEFAULTS: &[(TuneKind, Crc32TunedDefaults)] = &[
  ...
  (TuneKind::Zen4, Crc32TunedDefaults {
    crc32:  Crc32VariantTunedDefaults { streams: 8, portable_to_hwcrc: 64, hwcrc_to_fusion: usize::MAX, fusion_to_avx512: usize::MAX, fusion_to_vpclmul: 256, min_bytes_per_lane: Some(128) },
    crc32c: Crc32VariantTunedDefaults { streams: 1, portable_to_hwcrc: 64, hwcrc_to_fusion: 1024,     fusion_to_avx512: 1_048_576,  fusion_to_vpclmul: 256, min_bytes_per_lane: None },
  }),
  ...
  (TuneKind::IntelSpr, Crc32TunedDefaults {
    crc32:  Crc32VariantTunedDefaults { streams: 4, portable_to_hwcrc: 64, hwcrc_to_fusion: usize::MAX, fusion_to_avx512: usize::MAX, fusion_to_vpclmul: 2_048, min_bytes_per_lane: None },
    crc32c: Crc32VariantTunedDefaults { streams: 1, portable_to_hwcrc: 64, hwcrc_to_fusion: 2_048,     fusion_to_avx512: 2_048,       fusion_to_vpclmul: 2_048, min_bytes_per_lane: None },
  }),
  (TuneKind::IntelGnr, Crc32TunedDefaults {
    crc32:  Crc32VariantTunedDefaults { streams: 7, portable_to_hwcrc: 64, hwcrc_to_fusion: usize::MAX, fusion_to_avx512: usize::MAX, fusion_to_vpclmul: 2_048, min_bytes_per_lane: None },
    crc32c: Crc32VariantTunedDefaults { streams: 1, portable_to_hwcrc: 64, hwcrc_to_fusion: 2_048,     fusion_to_avx512: 2_048,       fusion_to_vpclmul: 2_048, min_bytes_per_lane: None },
  }),
  // Ice Lake prefers 256-bit operations; disable wide tiers by default.
  (TuneKind::IntelIcl, Crc32TunedDefaults {
    crc32:  Crc32VariantTunedDefaults { streams: 4, portable_to_hwcrc: 64, hwcrc_to_fusion: usize::MAX, fusion_to_avx512: usize::MAX, fusion_to_vpclmul: usize::MAX, min_bytes_per_lane: None },
    crc32c: Crc32VariantTunedDefaults { streams: 1, portable_to_hwcrc: 64, hwcrc_to_fusion: 2_048,     fusion_to_avx512: usize::MAX, fusion_to_vpclmul: usize::MAX, min_bytes_per_lane: None },
  }),

  // Apple M1-M3: PMULL+EOR3 fusion is fastest; switch from HWCRC at 512 bytes.
  (TuneKind::AppleM1M3, Crc32TunedDefaults {
    crc32:  Crc32VariantTunedDefaults { streams: 1, portable_to_hwcrc: 64, hwcrc_to_fusion: 512, fusion_to_avx512: usize::MAX, fusion_to_vpclmul: usize::MAX, min_bytes_per_lane: None },
    crc32c: Crc32VariantTunedDefaults { streams: 1, portable_to_hwcrc: 64, hwcrc_to_fusion: 512, fusion_to_avx512: usize::MAX, fusion_to_vpclmul: usize::MAX, min_bytes_per_lane: None },
  }),
  ...
  (TuneKind::Graviton2, Crc32TunedDefaults {
    crc32:  Crc32VariantTunedDefaults { streams: 1, portable_to_hwcrc: 64, hwcrc_to_fusion: 2048, fusion_to_avx512: usize::MAX, fusion_to_vpclmul: usize::MAX, min_bytes_per_lane: None },
    crc32c: Crc32VariantTunedDefaults { streams: 1, portable_to_hwcrc: 64, hwcrc_to_fusion: 2048, fusion_to_avx512: usize::MAX, fusion_to_vpclmul: usize::MAX, min_bytes_per_lane: None },
  }),
