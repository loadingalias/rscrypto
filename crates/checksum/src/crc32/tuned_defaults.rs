...
pub const CRC32_TUNED_DEFAULTS: &[(TuneKind, Crc32TunedDefaults)] = &[
  // BEGIN GENERATED (rscrypto-tune)  // Default: conservative x86_64 tuning (used when microarch is unknown).
  ...
  (TuneKind::AppleM1M3, Crc32TunedDefaults {
    ...
    crc32c: Crc32VariantTunedDefaults { streams: 1, portable_bytewise_to_slice16: 64, portable_to_hwcrc: 128, hwcrc_to_fusion: 256, fusion_to_avx512: usize::MAX, fusion_to_vpclmul: usize::MAX, min_bytes_per_lane: None },
  }),
