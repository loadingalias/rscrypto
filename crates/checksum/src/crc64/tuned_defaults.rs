...
pub const CRC64_TUNED_DEFAULTS: &[(TuneKind, Crc64TunedDefaults)] = &[
  ...
  (TuneKind::IntelSpr, Crc64TunedDefaults {
    xz:   Crc64VariantTunedDefaults { streams: 4, portable_to_clmul: 64, pclmul_to_vpclmul: 2_048, small_kernel_max_bytes: 512, min_bytes_per_lane: None },
    nvme: Crc64VariantTunedDefaults { streams: 4, portable_to_clmul: 64, pclmul_to_vpclmul: 2_048, small_kernel_max_bytes: 512, min_bytes_per_lane: None },
  }),
  (TuneKind::IntelGnr, Crc64TunedDefaults {
    xz:   Crc64VariantTunedDefaults { streams: 7, portable_to_clmul: 64, pclmul_to_vpclmul: 2_048, small_kernel_max_bytes: 512, min_bytes_per_lane: None },
    nvme: Crc64VariantTunedDefaults { streams: 7, portable_to_clmul: 64, pclmul_to_vpclmul: 2_048, small_kernel_max_bytes: 512, min_bytes_per_lane: None },
  }),
  // Ice Lake prefers 256-bit operations; disable VPCLMUL selection by default.
  (TuneKind::IntelIcl, Crc64TunedDefaults {
    xz:   Crc64VariantTunedDefaults { streams: 4, portable_to_clmul: 64, pclmul_to_vpclmul: usize::MAX, small_kernel_max_bytes: 512, min_bytes_per_lane: None },
    nvme: Crc64VariantTunedDefaults { streams: 4, portable_to_clmul: 64, pclmul_to_vpclmul: usize::MAX, small_kernel_max_bytes: 512, min_bytes_per_lane: None },
  }),
...
mod invariants {
  ...
  fn assert_variant(v: Crc64VariantTunedDefaults) {
    ...
    assert!(v.small_kernel_max_bytes >= 1);
