...
pub const CRC64_TUNED_DEFAULTS: &[(TuneKind, Crc64TunedDefaults)] = &[
  ...
  (TuneKind::AppleM1M3, Crc64TunedDefaults {
    xz:   Crc64VariantTunedDefaults { streams: 3, portable_to_clmul: 64, pclmul_to_vpclmul: usize::MAX, small_kernel_max_bytes: 128, min_bytes_per_lane: Some(2730) },
    nvme: Crc64VariantTunedDefaults { streams: 3, portable_to_clmul: 64, pclmul_to_vpclmul: 2048, small_kernel_max_bytes: 128, min_bytes_per_lane: Some(2730) },
  }),
