...
rscrypto_blake3_hash_many_sse41:
        ...
        movdqa xmm1, xmm0
        pand xmm1, xmmword ptr [RSCRYPTO_SSE41_ADD0+rip]
        pand xmm0, xmmword ptr [RSCRYPTO_SSE41_ADD1+rip]
        movdqa xmmword ptr [rsp+0x150], xmm0
        movd xmm0, r8d
        pshufd xmm0, xmm0, 0x00
        paddd xmm0, xmm1
        movdqa xmmword ptr [rsp+0x110], xmm0
        pxor xmm0, xmmword ptr [RSCRYPTO_SSE41_CMP_MSB_MASK+rip]
        pxor xmm1, xmmword ptr [RSCRYPTO_SSE41_CMP_MSB_MASK+rip]
        pcmpgtd xmm1, xmm0
        shr r8, 32
        movd xmm2, r8d
...
9:
        ...
        movdqa xmm9, xmmword ptr [RSCRYPTO_SSE41_BLAKE3_IV_1+rip]
        movdqa xmm10, xmmword ptr [RSCRYPTO_SSE41_BLAKE3_IV_2+rip]
        movdqa xmm11, xmmword ptr [RSCRYPTO_SSE41_BLAKE3_IV_3+rip]
        movdqa xmm12, xmmword ptr [rsp+0x110]
        movdqa xmm13, xmmword ptr [rsp+0x120]
        movdqa xmm14, xmmword ptr [RSCRYPTO_SSE41_BLAKE3_BLOCK_LEN+rip]
        movd xmm15, eax
        ...
        pxor xmm14, xmm2
        pxor xmm15, xmm3
        movdqa xmm8, xmmword ptr [RSCRYPTO_SSE41_ROT16+rip]
        pshufb xmm12, xmm8
        pshufb xmm13, xmm8
        pshufb xmm14, xmm8
        pshufb xmm15, xmm8
        movdqa xmm8, xmmword ptr [RSCRYPTO_SSE41_BLAKE3_IV_0+rip]
        paddd xmm8, xmm12
        paddd xmm9, xmm13
        paddd xmm10, xmm14
        paddd xmm11, xmm15
        ...
        pxor xmm14, xmm2
        pxor xmm15, xmm3
        movdqa xmm8, xmmword ptr [RSCRYPTO_SSE41_ROT8+rip]
        pshufb xmm12, xmm8
        pshufb xmm13, xmm8
        pshufb xmm14, xmm8
        pshufb xmm15, xmm8
...
3:
        ...
        pinsrd xmm13, dword ptr [RSCRYPTO_SSE41_BLAKE3_BLOCK_LEN+rip], 2
        movaps xmmword ptr [rsp], xmm13
        movd xmm14, dword ptr [rsp+0x114]
        pinsrd xmm14, dword ptr [rsp+0x124], 1
        pinsrd xmm14, dword ptr [RSCRYPTO_SSE41_BLAKE3_BLOCK_LEN+rip], 2
...
9:
        ...
        pxor xmm3, xmm0
        pxor xmm11, xmm8
        movaps xmm12, xmmword ptr [RSCRYPTO_SSE41_ROT16+rip]
        pshufb xmm3, xmm12
        pshufb xmm11, xmm12
        paddd xmm2, xmm3
        paddd xmm10, xmm11
        ...
        pxor xmm3, xmm0
        pxor xmm11, xmm8
        movaps xmm13, xmmword ptr [RSCRYPTO_SSE41_ROT8+rip]
        pshufb xmm3, xmm13
        pshufb xmm11, xmm13
        paddd xmm2, xmm3
        paddd xmm10, xmm11
...
3:
        ...
        pinsrd xmm13, dword ptr [rsp+0x120], 1
        pinsrd xmm13, dword ptr [RSCRYPTO_SSE41_BLAKE3_BLOCK_LEN+rip], 2
        movaps xmm14, xmmword ptr [RSCRYPTO_SSE41_ROT8+rip]
        movaps xmm15, xmmword ptr [RSCRYPTO_SSE41_ROT16+rip]
        mov r8, qword ptr [rdi]
        movzx eax, byte ptr [rbp+0x40]
        or eax, r13d
        xor edx, edx
...
RSCRYPTO_SSE41_ADD1:
 .long 4, 4, 4, 4
RSCRYPTO_SSE41_BLAKE3_IV_0:
 .long 0x6A09E667, 0x6A09E667, 0x6A09E667, 0x6A09E667
RSCRYPTO_SSE41_BLAKE3_IV_1:
 .long 0xBB67AE85, 0xBB67AE85, 0xBB67AE85, 0xBB67AE85
RSCRYPTO_SSE41_BLAKE3_IV_2:
 .long 0x3C6EF372, 0x3C6EF372, 0x3C6EF372, 0x3C6EF372
RSCRYPTO_SSE41_BLAKE3_IV_3:
 .long 0xA54FF53A, 0xA54FF53A, 0xA54FF53A, 0xA54FF53A
RSCRYPTO_SSE41_BLAKE3_BLOCK_LEN:
 .long 64, 64, 64, 64
RSCRYPTO_SSE41_CMP_MSB_MASK:
