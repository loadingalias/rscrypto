...
use super::{
  BLOCK_LEN, Sha512_224,
  dispatch_tables::DispatchTable,
  kernels::{CompressBlocksFn, Sha512_224KernelId, compress_blocks_fn, required_caps},
};
...
#[inline]
#[must_use]
fn resolve(id: Sha512_224KernelId, caps: Caps) -> Sha512_224KernelId {
  if caps.has(required_caps(id)) {
    id
  } else {
    Sha512_224KernelId::Portable
  }
}
