...
#[cfg(target_arch = "x86_64")]
pub static X86_AVX2_STD_TABLE: DispatchTable = DispatchTable {
  boundaries: DEFAULT_BOUNDARIES,
  xs: KernelId::X86Avx2Std,
  s: KernelId::X86Avx2Std,
  m: KernelId::X86Avx2Std,
  l: KernelId::X86Avx2Std,
};

#[cfg(target_arch = "x86_64")]
pub static X86_AVX512VL_STD_TABLE: DispatchTable = DispatchTable {
  boundaries: DEFAULT_BOUNDARIES,
  xs: KernelId::X86Avx512vlStd,
  s: KernelId::X86Avx512vlStd,
  m: KernelId::X86Avx512vlStd,
