...
.global rscrypto_blake3_hash_many_avx2
.global rscrypto_blake3_compress_in_place_avx2
.section .text
        .p2align  6
...
// AVX2 compress_in_place — VEX-encoded 128-bit ops with vpshufb for rotations.
// Same algorithm and calling convention as AVX-512 compress_in_place, but without
// vprord (requires AVX-512). Uses existing ROT16/ROT8 masks from the data section.
.p2align 6
