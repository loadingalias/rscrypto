...
//! rscrypto = { version = "0.9", default-features = false, features = ["crypto-hashes"] }
//!
//! # Fast non-cryptographic hashes only
//! rscrypto = { version = "0.9", default-features = false, features = ["fast-hashes"] }
//!
//! # Everything hash-related
//! rscrypto = { version = "0.9", default-features = false, features = ["hashes"] }
//! ```
//!
