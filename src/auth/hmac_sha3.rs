...
use super::hmac_tag::define_hmac_tag_type;
use crate::{
...
define_hmac_tag_type!(HmacSha3_224Tag, SHA3_224_TAG_SIZE, "HMAC-SHA3-224 authentication tag.");
define_hmac_tag_type!(HmacSha3_256Tag, SHA3_256_TAG_SIZE, "HMAC-SHA3-256 authentication tag.");
define_hmac_tag_type!(HmacSha3_384Tag, SHA3_384_TAG_SIZE, "HMAC-SHA3-384 authentication tag.");
define_hmac_tag_type!(HmacSha3_512Tag, SHA3_512_TAG_SIZE, "HMAC-SHA3-512 authentication tag.");
