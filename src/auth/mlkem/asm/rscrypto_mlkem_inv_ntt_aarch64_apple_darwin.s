...
//
// ABI:
//   rscrypto_mlkem_inv_ntt_aarch64_apple_darwin:
...
.p2align 2
Lrscrypto_mlkem_inv_ntt_butterflies_aarch64_apple_darwin:
	mov	x8, #-8
	mov	w10, #3329
	add	x9, x1, #254
	dup	v0.4h, w10
...
.globl _rscrypto_mlkem_inv_ntt_aarch64_apple_darwin
.private_extern _rscrypto_mlkem_inv_ntt_aarch64_apple_darwin
_rscrypto_mlkem_inv_ntt_aarch64_apple_darwin:
        stp     x19, x30, [sp, #-16]!
        mov     w19, w2
        bl      Lrscrypto_mlkem_inv_ntt_butterflies_aarch64_apple_darwin
        FINAL_SCALE w19
        ldp     x19, x30, [sp], #16
        ret

.globl _rscrypto_mlkem_inv_ntt_add_aarch64_apple_darwin
.private_extern _rscrypto_mlkem_inv_ntt_add_aarch64_apple_darwin
_rscrypto_mlkem_inv_ntt_add_aarch64_apple_darwin:
        stp     x29, x30, [sp, #-32]!
        stp     x19, x20, [sp, #16]
        mov     x29, sp
        mov     x19, x1
