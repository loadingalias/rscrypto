...
//! rscrypto = { version = "0.9", default-features = false, features = ["macs"] }
//!
//! # HKDF only
//! rscrypto = { version = "0.9", default-features = false, features = ["hkdf"] }
//!
//! # Ed25519 only
//! rscrypto = { version = "0.9", default-features = false, features = ["ed25519"] }
//!
//! # ECDSA P-256/P-384 signing and verification
//! rscrypto = { version = "0.9", default-features = false, features = ["ecdsa"] }
//!
//! # RSA
//! rscrypto = { version = "0.9", default-features = false, features = ["rsa"] }
//!
...
pub use rsa::{
  ...
  diag_rsa_private_exponentiate_fixed_width_with_scratch, diag_rsa_private_select_window_power_4,
