...
//
// Adapted for rscrypto from the s2n-bignum AArch64 Curve25519 X25519 byte backends.
...
rscrypto_curve25519_x25519base_byte_alt:
        ...
        ldr x0, [sp, #(0*32)]
        ands xzr, x0, #8
        adrp x19, rscrypto_curve25519_x25519base_byte_alt_constant
        add x19, x19, :lo12:rscrypto_curve25519_x25519base_byte_alt_constant
        ldp x0, x1, [x19]
        ldp x2, x3, [x19, #96]
        csel x0, x0, x2, eq
        csel x1, x1, x3, eq
...
Lcurve25519_x25519base_byte_alt_invmidloop:
        ...
        ldp x19, x20, [sp], #16 ; .cfi_adjust_cfa_offset -16 ; .cfi_restore x19 ; .cfi_restore x20
        ret ; .cfi_endproc
.size rscrypto_curve25519_x25519base_byte_alt, .-rscrypto_curve25519_x25519base_byte_alt
.section .rodata
rscrypto_curve25519_x25519base_byte_alt_constant:
