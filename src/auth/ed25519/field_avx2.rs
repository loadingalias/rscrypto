...
impl FieldElement2625x4 {
  ...
  // -------------------------------------------------------------------------
  // AVX-512 IFMA multiply / square
  // -------------------------------------------------------------------------
  //
  // Same schoolbook structure as the AVX2 variants, but each
  // `add64(mul32(a, b), acc)` pair becomes a single `vpmadd52luq`:
  //   acc = _mm256_madd52lo_epu64(acc, a, b)
  // This roughly halves instruction count in the inner loops.
  //
  // The reduction chain (`reduce64`) is shared — accumulator ranges
  // are identical.

  /// IFMA fused multiply-accumulate: `acc += (a * b)[51:0]` per lane.
  ///
  /// # Safety
  ///
  ...
  ///
  /// Same schoolbook as `mul` but uses fused multiply-accumulate
  /// (`vpmadd52luq`) — ~50% fewer instructions.
  ///
  /// # Safety
  ///
  /// Caller must ensure AVX-512 IFMA + VL are available.
  ...
  #[target_feature(enable = "avx2,avx512ifma,avx512vl")]
  #[allow(unsafe_op_in_unsafe_fn)]
  pub(crate) unsafe fn mul_ifma(&self, rhs: &Self) -> Self {
    let v19 = _mm256_set1_epi64x(19);
    let zero = _mm256_setzero_si256();
    ...
    // Schoolbook with fused multiply-accumulate.
    let mut z0 = Self::madd52lo(zero, x0, y0);
    z0 = Self::madd52lo(z0, x1_2, y9_19);
    z0 = Self::madd52lo(z0, x2, y8_19);
    z0 = Self::madd52lo(z0, x3_2, y7_19);
    z0 = Self::madd52lo(z0, x4, y6_19);
    z0 = Self::madd52lo(z0, x5_2, y5_19);
    z0 = Self::madd52lo(z0, x6, y4_19);
    z0 = Self::madd52lo(z0, x7_2, y3_19);
    z0 = Self::madd52lo(z0, x8, y2_19);
    z0 = Self::madd52lo(z0, x9_2, y1_19);

    let mut z1 = Self::madd52lo(zero, x0, y1);
    z1 = Self::madd52lo(z1, x1, y0);
    z1 = Self::madd52lo(z1, x2, y9_19);
    z1 = Self::madd52lo(z1, x3, y8_19);
    z1 = Self::madd52lo(z1, x4, y7_19);
    z1 = Self::madd52lo(z1, x5, y6_19);
    z1 = Self::madd52lo(z1, x6, y5_19);
    z1 = Self::madd52lo(z1, x7, y4_19);
    z1 = Self::madd52lo(z1, x8, y3_19);
    z1 = Self::madd52lo(z1, x9, y2_19);

    let mut z2 = Self::madd52lo(zero, x0, y2);
    z2 = Self::madd52lo(z2, x1_2, y1);
    z2 = Self::madd52lo(z2, x2, y0);
    z2 = Self::madd52lo(z2, x3_2, y9_19);
    z2 = Self::madd52lo(z2, x4, y8_19);
    z2 = Self::madd52lo(z2, x5_2, y7_19);
    z2 = Self::madd52lo(z2, x6, y6_19);
    z2 = Self::madd52lo(z2, x7_2, y5_19);
    z2 = Self::madd52lo(z2, x8, y4_19);
    z2 = Self::madd52lo(z2, x9_2, y3_19);

    let mut z3 = Self::madd52lo(zero, x0, y3);
    z3 = Self::madd52lo(z3, x1, y2);
    z3 = Self::madd52lo(z3, x2, y1);
    z3 = Self::madd52lo(z3, x3, y0);
    z3 = Self::madd52lo(z3, x4, y9_19);
    z3 = Self::madd52lo(z3, x5, y8_19);
    z3 = Self::madd52lo(z3, x6, y7_19);
    z3 = Self::madd52lo(z3, x7, y6_19);
    z3 = Self::madd52lo(z3, x8, y5_19);
    z3 = Self::madd52lo(z3, x9, y4_19);

    let mut z4 = Self::madd52lo(zero, x0, y4);
    z4 = Self::madd52lo(z4, x1_2, y3);
    z4 = Self::madd52lo(z4, x2, y2);
    z4 = Self::madd52lo(z4, x3_2, y1);
    z4 = Self::madd52lo(z4, x4, y0);
    z4 = Self::madd52lo(z4, x5_2, y9_19);
    z4 = Self::madd52lo(z4, x6, y8_19);
    z4 = Self::madd52lo(z4, x7_2, y7_19);
    z4 = Self::madd52lo(z4, x8, y6_19);
    z4 = Self::madd52lo(z4, x9_2, y5_19);

    let mut z5 = Self::madd52lo(zero, x0, y5);
    z5 = Self::madd52lo(z5, x1, y4);
    z5 = Self::madd52lo(z5, x2, y3);
    z5 = Self::madd52lo(z5, x3, y2);
    z5 = Self::madd52lo(z5, x4, y1);
    z5 = Self::madd52lo(z5, x5, y0);
    z5 = Self::madd52lo(z5, x6, y9_19);
    z5 = Self::madd52lo(z5, x7, y8_19);
    z5 = Self::madd52lo(z5, x8, y7_19);
    z5 = Self::madd52lo(z5, x9, y6_19);

    let mut z6 = Self::madd52lo(zero, x0, y6);
    z6 = Self::madd52lo(z6, x1_2, y5);
    z6 = Self::madd52lo(z6, x2, y4);
    z6 = Self::madd52lo(z6, x3_2, y3);
    z6 = Self::madd52lo(z6, x4, y2);
    z6 = Self::madd52lo(z6, x5_2, y1);
    z6 = Self::madd52lo(z6, x6, y0);
    z6 = Self::madd52lo(z6, x7_2, y9_19);
    z6 = Self::madd52lo(z6, x8, y8_19);
    z6 = Self::madd52lo(z6, x9_2, y7_19);

    let mut z7 = Self::madd52lo(zero, x0, y7);
    z7 = Self::madd52lo(z7, x1, y6);
    z7 = Self::madd52lo(z7, x2, y5);
    z7 = Self::madd52lo(z7, x3, y4);
    z7 = Self::madd52lo(z7, x4, y3);
    z7 = Self::madd52lo(z7, x5, y2);
    z7 = Self::madd52lo(z7, x6, y1);
    z7 = Self::madd52lo(z7, x7, y0);
    z7 = Self::madd52lo(z7, x8, y9_19);
    z7 = Self::madd52lo(z7, x9, y8_19);

    let mut z8 = Self::madd52lo(zero, x0, y8);
    z8 = Self::madd52lo(z8, x1_2, y7);
    z8 = Self::madd52lo(z8, x2, y6);
    z8 = Self::madd52lo(z8, x3_2, y5);
    z8 = Self::madd52lo(z8, x4, y4);
    z8 = Self::madd52lo(z8, x5_2, y3);
    z8 = Self::madd52lo(z8, x6, y2);
    z8 = Self::madd52lo(z8, x7_2, y1);
    z8 = Self::madd52lo(z8, x8, y0);
    z8 = Self::madd52lo(z8, x9_2, y9_19);

    let mut z9 = Self::madd52lo(zero, x0, y9);
    z9 = Self::madd52lo(z9, x1, y8);
    z9 = Self::madd52lo(z9, x2, y7);
    z9 = Self::madd52lo(z9, x3, y6);
    z9 = Self::madd52lo(z9, x4, y5);
    z9 = Self::madd52lo(z9, x5, y4);
    z9 = Self::madd52lo(z9, x6, y3);
    z9 = Self::madd52lo(z9, x7, y2);
    z9 = Self::madd52lo(z9, x8, y1);
    z9 = Self::madd52lo(z9, x9, y0);

    let mut z = [z0, z1, z2, z3, z4, z5, z6, z7, z8, z9];
    Self::reduce64(&mut z)
  }

  /// Square using AVX-512 IFMA fused multiply-accumulate.
  ///
  /// # Safety
  ///
  /// Caller must ensure AVX-512 IFMA + VL are available.
  ...
  #[target_feature(enable = "avx2,avx512ifma,avx512vl")]
  #[allow(unsafe_op_in_unsafe_fn)]
  pub(crate) unsafe fn square_ifma(&self) -> Self {
    let v19 = _mm256_set1_epi64x(19);
    let v38 = _mm256_set1_epi64x(38);
    let zero = _mm256_setzero_si256();
    ...
    let mut z0 = Self::madd52lo(zero, x0, x0);
    z0 = Self::madd52lo(z0, x1_38, x9_19);
    z0 = Self::madd52lo(z0, x2_2, x8_19);
    z0 = Self::madd52lo(z0, x3_38, x7_19);
    z0 = Self::madd52lo(z0, x4_2, x6_19);
    z0 = Self::madd52lo(z0, x5_2, x5_19);

    let mut z1 = Self::madd52lo(zero, x0_2, x1);
    z1 = Self::madd52lo(z1, x2_2, x9_19);
    z1 = Self::madd52lo(z1, x3_2, x8_19);
    z1 = Self::madd52lo(z1, x4_2, x7_19);
    z1 = Self::madd52lo(z1, x5_2, x6_19);

    let mut z2 = Self::madd52lo(zero, x0_2, x2);
    z2 = Self::madd52lo(z2, x1_2, x1);
    z2 = Self::madd52lo(z2, x3_38, x9_19);
    z2 = Self::madd52lo(z2, x4_2, x8_19);
    z2 = Self::madd52lo(z2, x5_38, x7_19);
    z2 = Self::madd52lo(z2, x6, x6_19);

    let mut z3 = Self::madd52lo(zero, x0_2, x3);
    z3 = Self::madd52lo(z3, x1_2, x2);
    z3 = Self::madd52lo(z3, x4_2, x9_19);
    z3 = Self::madd52lo(z3, x5_2, x8_19);
    z3 = Self::madd52lo(z3, x6_2, x7_19);

    let mut z4 = Self::madd52lo(zero, x0_2, x4);
    z4 = Self::madd52lo(z4, x1_38, x3);
    z4 = Self::madd52lo(z4, x2, x2);
    z4 = Self::madd52lo(z4, x5_38, x9_19);
    z4 = Self::madd52lo(z4, x6_2, x8_19);
    z4 = Self::madd52lo(z4, x7_2, x7_19);

    let mut z5 = Self::madd52lo(zero, x0_2, x5);
    z5 = Self::madd52lo(z5, x1_2, x4);
    z5 = Self::madd52lo(z5, x2_2, x3);
    z5 = Self::madd52lo(z5, x6_2, x9_19);
    z5 = Self::madd52lo(z5, x7_2, x8_19);

    let mut z6 = Self::madd52lo(zero, x0_2, x6);
    z6 = Self::madd52lo(z6, x1_38, x5);
    z6 = Self::madd52lo(z6, x2_2, x4);
    z6 = Self::madd52lo(z6, x3_2, x3);
    z6 = Self::madd52lo(z6, x7_38, x9_19);
    z6 = Self::madd52lo(z6, x8, x8_19);

    let x8_2 = add64(x8, x8);
    let mut z7 = Self::madd52lo(zero, x0_2, x7);
    z7 = Self::madd52lo(z7, x1_2, x6);
    z7 = Self::madd52lo(z7, x2_2, x5);
    z7 = Self::madd52lo(z7, x3_2, x4);
    z7 = Self::madd52lo(z7, x8_2, x9_19);

    let x9_2 = add64(x9, x9);
    let mut z8 = Self::madd52lo(zero, x0_2, x8);
    z8 = Self::madd52lo(z8, x1_38, x7);
    z8 = Self::madd52lo(z8, x2_2, x6);
    z8 = Self::madd52lo(z8, x3_38, x5);
    z8 = Self::madd52lo(z8, x4, x4);
    z8 = Self::madd52lo(z8, x9_2, x9_19);

    let mut z9 = Self::madd52lo(zero, x0_2, x9);
    z9 = Self::madd52lo(z9, x1_2, x8);
    z9 = Self::madd52lo(z9, x2_2, x7);
    z9 = Self::madd52lo(z9, x3_2, x6);
    z9 = Self::madd52lo(z9, x4_2, x5);

    let mut z = [z0, z1, z2, z3, z4, z5, z6, z7, z8, z9];
    Self::reduce64(&mut z)
  }

  /// Square and negate D lane using AVX-512 IFMA.
  ///
  /// # Safety
  ///
  /// Caller must ensure AVX-512 IFMA + VL are available.
  ...
  #[target_feature(enable = "avx2,avx512ifma,avx512vl")]
  #[allow(unsafe_op_in_unsafe_fn)]
  pub(crate) unsafe fn square_and_negate_d_ifma(&self) -> Self {
    let mut result = self.square_ifma();
    Self::negate_d_lane(&mut result);
    result
  }
}
