...
// - edwards25519_scalarmulbase_alt.S
//
// The public symbol is renamed to the rscrypto namespace and embedded with Rust global_asm!.



        .globl rscrypto_edwards25519_scalarmulbase_alt
        .type rscrypto_edwards25519_scalarmulbase_alt, %function
        .hidden rscrypto_edwards25519_scalarmulbase_alt
        .text
        .balign 4
rscrypto_edwards25519_scalarmulbase_alt:
        .cfi_startproc
        ...
        ldp x12, x13, [x1, #16]
        lsr x9, x13, #60
        movz x0, #0xd3ed ; movk x0, #0x5cf5, lsl #16 ; movk x0, #0x631a, lsl #32 ; movk x0, #0x5812, lsl #48;
        movz x1, #0x9cd6 ; movk x1, #0xa2f7, lsl #16 ; movk x1, #0xf9de, lsl #32 ; movk x1, #0x14de, lsl #48;
        mul x2, x9, x0
        mul x3, x9, x1
        umulh x4, x9, x0
        umulh x5, x9, x1
        ...
        adrp x19, rscrypto_edwards25519_scalarmulbase_alt_constant
        add x19, x19, :lo12:rscrypto_edwards25519_scalarmulbase_alt_constant
        ldp x0, x1, [x19]
        ldp x2, x3, [x19, #96]
        csel x0, x0, x2, eq
        csel x1, x1, x3, eq
        ...
        add x19, x19, #192
        mov x21, xzr
Lrscrypto_edwards25519_scalarmulbase_alt_scalarloop:
        lsr x0, x20, #6
        ldr x2, [sp, x0, lsl #3]
        lsr x2, x2, x20
        and x2, x2, #15
        ...
        add x20, x20, 4
        cmp x20, 252
        bcc Lrscrypto_edwards25519_scalarmulbase_alt_scalarloop
        ldp x0, x1, [sp, #(4*32)]
        ldp x2, x3, [sp, #(4*32)+16]
        ...
        mov x21, #0xa
        mov x22, #0x1
        b Lrscrypto_edwards25519_scalarmulbase_alt_invmidloop
Lrscrypto_edwards25519_scalarmulbase_alt_invloop:
        cmp x10, xzr
        csetm x14, mi
        cneg x10, x10, mi
        cmp x11, xzr
        ...
        stp x0, x1, [sp, #96]
        stp x3, x2, [sp, #112]
Lrscrypto_edwards25519_scalarmulbase_alt_invmidloop:
        mov x1, x22
        ldr x2, [sp]
        ldr x3, [sp, #32]
        and x4, x2, #0xfffff
        ...
        mov x22, x1
        subs x21, x21, #0x1
        b.ne Lrscrypto_edwards25519_scalarmulbase_alt_invloop
        ldr x0, [sp]
        ldr x1, [sp, #32]
        mul x0, x0, x10
        madd x1, x1, x11, x0
        ...
        ret ; .cfi_endproc
.size rscrypto_edwards25519_scalarmulbase_alt, .-rscrypto_edwards25519_scalarmulbase_alt
.section .note.GNU-stack, "", %progbits
.section .rodata
.type rscrypto_edwards25519_scalarmulbase_alt_constant, %object
.size rscrypto_edwards25519_scalarmulbase_alt_constant, 48576
rscrypto_edwards25519_scalarmulbase_alt_constant:
