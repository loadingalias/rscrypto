...
// The symbols are renamed to the rscrypto namespace and embedded with Rust global_asm!.
        ...
        .globl rscrypto_edwards25519_decode_alt
        .type rscrypto_edwards25519_decode_alt, %function
        .hidden rscrypto_edwards25519_decode_alt
        .text
        .balign 4
rscrypto_edwards25519_decode_alt:
        .cfi_startproc
        ...
        adcs xzr, x7, xzr
        cset x21, mi
        add x0, sp, #(16*8) ; mov x1, 1 ; add x2, sp, #0 ; bl Lrscrypto_edwards25519_decode_alt_nsqr_p25519
        ldp x0, x1, [sp, #(16*8)]
        ...
        add x0, sp, #(16*8) ; add x1, sp, #(20*8) ; add x2, sp, #(16*8) ; bl Lrscrypto_edwards25519_decode_alt_mul_p25519
        ldp x0, x1, [sp, #(16*8)]
        ldp x2, x3, [sp, #(16*8)+16]
        adds x0, x0, #1
        adcs x1, x1, xzr
        ...
        add x0, sp, #(20*8) ; add x1, sp, #(12*8) ; add x2, sp, #(16*8) ; bl Lrscrypto_edwards25519_decode_alt_mul_p25519
        add x0, sp, #(8*8) ; mov x1, 1 ; add x2, sp, #(20*8) ; bl Lrscrypto_edwards25519_decode_alt_nsqr_p25519
        add x0, sp, #(8*8) ; add x1, sp, #(8*8) ; add x2, sp, #(20*8) ; bl Lrscrypto_edwards25519_decode_alt_mul_p25519
        add x0, sp, #(4*8) ; mov x1, 2 ; add x2, sp, #(8*8) ; bl Lrscrypto_edwards25519_decode_alt_nsqr_p25519
        add x0, sp, #(8*8) ; add x1, sp, #(4*8) ; add x2, sp, #(8*8) ; bl Lrscrypto_edwards25519_decode_alt_mul_p25519
        add x0, sp, #(4*8) ; mov x1, 1 ; add x2, sp, #(8*8) ; bl Lrscrypto_edwards25519_decode_alt_nsqr_p25519
        add x0, sp, #(16*8) ; add x1, sp, #(4*8) ; add x2, sp, #(20*8) ; bl Lrscrypto_edwards25519_decode_alt_mul_p25519
        add x0, sp, #(4*8) ; mov x1, 5 ; add x2, sp, #(16*8) ; bl Lrscrypto_edwards25519_decode_alt_nsqr_p25519
        add x0, sp, #(8*8) ; add x1, sp, #(4*8) ; add x2, sp, #(16*8) ; bl Lrscrypto_edwards25519_decode_alt_mul_p25519
        add x0, sp, #(4*8) ; mov x1, 10 ; add x2, sp, #(8*8) ; bl Lrscrypto_edwards25519_decode_alt_nsqr_p25519
        add x0, sp, #(8*8) ; add x1, sp, #(4*8) ; add x2, sp, #(8*8) ; bl Lrscrypto_edwards25519_decode_alt_mul_p25519
        add x0, sp, #(4*8) ; mov x1, 5 ; add x2, sp, #(8*8) ; bl Lrscrypto_edwards25519_decode_alt_nsqr_p25519
        add x0, sp, #(16*8) ; add x1, sp, #(4*8) ; add x2, sp, #(16*8) ; bl Lrscrypto_edwards25519_decode_alt_mul_p25519
        add x0, sp, #(4*8) ; mov x1, 25 ; add x2, sp, #(16*8) ; bl Lrscrypto_edwards25519_decode_alt_nsqr_p25519
        add x0, sp, #(8*8) ; add x1, sp, #(4*8) ; add x2, sp, #(16*8) ; bl Lrscrypto_edwards25519_decode_alt_mul_p25519
        add x0, sp, #(4*8) ; mov x1, 50 ; add x2, sp, #(8*8) ; bl Lrscrypto_edwards25519_decode_alt_nsqr_p25519
        add x0, sp, #(8*8) ; add x1, sp, #(4*8) ; add x2, sp, #(8*8) ; bl Lrscrypto_edwards25519_decode_alt_mul_p25519
        add x0, sp, #(4*8) ; mov x1, 25 ; add x2, sp, #(8*8) ; bl Lrscrypto_edwards25519_decode_alt_nsqr_p25519
        add x0, sp, #(16*8) ; add x1, sp, #(4*8) ; add x2, sp, #(16*8) ; bl Lrscrypto_edwards25519_decode_alt_mul_p25519
        add x0, sp, #(4*8) ; mov x1, 125 ; add x2, sp, #(16*8) ; bl Lrscrypto_edwards25519_decode_alt_nsqr_p25519
        add x0, sp, #(16*8) ; add x1, sp, #(4*8) ; add x2, sp, #(16*8) ; bl Lrscrypto_edwards25519_decode_alt_mul_p25519
        add x0, sp, #(4*8) ; mov x1, 2 ; add x2, sp, #(16*8) ; bl Lrscrypto_edwards25519_decode_alt_nsqr_p25519
        add x0, sp, #(4*8) ; add x1, sp, #(4*8) ; add x2, sp, #(20*8) ; bl Lrscrypto_edwards25519_decode_alt_mul_p25519
        add x0, sp, #(16*8) ; mov x1, 1 ; add x2, sp, #(4*8) ; bl Lrscrypto_edwards25519_decode_alt_nsqr_p25519
        add x0, sp, #(16*8) ; add x1, sp, #(16*8) ; add x2, sp, #(20*8) ; bl Lrscrypto_edwards25519_decode_alt_mul_p25519
        add x0, sp, #(4*8) ; add x1, sp, #(12*8) ; add x2, sp, #(4*8) ; bl Lrscrypto_edwards25519_decode_alt_mul_p25519
        ...
        ret ; .cfi_endproc
.size rscrypto_edwards25519_decode_alt, .-rscrypto_edwards25519_decode_alt
.type Lrscrypto_edwards25519_decode_alt_mul_p25519, %function
Lrscrypto_edwards25519_decode_alt_mul_p25519:
        .cfi_startproc
        ldp x3, x4, [x1]
        ldp x7, x8, [x2]
        mul x12, x3, x7
        ...
        stp x14, x15, [x0, #16]
        ret ; .cfi_endproc
.size Lrscrypto_edwards25519_decode_alt_mul_p25519, .-Lrscrypto_edwards25519_decode_alt_mul_p25519
.type Lrscrypto_edwards25519_decode_alt_nsqr_p25519, %function
Lrscrypto_edwards25519_decode_alt_nsqr_p25519:
        .cfi_startproc
        ldp x6, x3, [x2]
        ldp x4, x5, [x2, #16]
        mov x2, x6
Lrscrypto_edwards25519_decode_alt_loop:
        mul x9, x2, x3
        umulh x10, x2, x3
        mul x11, x2, x5
        umulh x12, x2, x5
        ...
        adc x5, x11, xzr
        subs x1, x1, #1
        bne Lrscrypto_edwards25519_decode_alt_loop
        adds x6, x2, #19
        adcs x7, x3, xzr
        adcs x8, x4, xzr
        adcs x9, x5, xzr
        ...
        stp x4, x5, [x0, #16]
        ret ; .cfi_endproc
.size Lrscrypto_edwards25519_decode_alt_nsqr_p25519, .-Lrscrypto_edwards25519_decode_alt_nsqr_p25519
.section .note.GNU-stack, "", %progbits



        .globl rscrypto_edwards25519_scalarmuldouble_alt
        .type rscrypto_edwards25519_scalarmuldouble_alt, %function
        .hidden rscrypto_edwards25519_scalarmuldouble_alt
        .text
        .balign 4
rscrypto_edwards25519_scalarmuldouble_alt:
        ...
        add x23, sp, #(13*32)
        bl Lrscrypto_edwards25519_scalarmuldouble_alt_epdouble
        add x22, sp, #(13*32)+2*128
        add x23, sp, #(13*32)
        add x24, sp, #(13*32)+1*128
        bl Lrscrypto_edwards25519_scalarmuldouble_alt_epadd
        ...
        ldr x0, [sp, #(1*32)+24]
        lsr x20, x0, #60
        adrp x14, rscrypto_edwards25519_scalarmuldouble_alt_constant
        add x14, x14, :lo12:rscrypto_edwards25519_scalarmuldouble_alt_constant
        mov x0, #1
        mov x1, xzr
        mov x2, xzr
        mov x3, xzr
        ...
        add x23, sp, #(9*32)
        add x24, sp, #(2*32)
        bl Lrscrypto_edwards25519_scalarmuldouble_alt_pepadd
Lrscrypto_edwards25519_scalarmuldouble_alt_loop:
        sub x19, x19, #4
        add x22, sp, #(5*32)
        add x23, sp, #(5*32)
        bl Lrscrypto_edwards25519_scalarmuldouble_alt_pdouble
        lsr x0, x19, #6
        add x1, sp, #(1*32)
        ldr x2, [x1, x0, lsl #3]
        lsr x3, x2, x19
        ...
        add x24, sp, #(9*32)
        bl Lrscrypto_edwards25519_scalarmuldouble_alt_epadd
        cbnz x19, Lrscrypto_edwards25519_scalarmuldouble_alt_loop
        add x0, sp, #(9*32)
        add x1, sp, #(5*32)+64
        mov x20, x0
        ...
        mov x21, #0xa
        mov x22, #0x1
        b Lrscrypto_edwards25519_scalarmuldouble_alt_invmidloop
Lrscrypto_edwards25519_scalarmuldouble_alt_invloop:
        cmp x10, xzr
        csetm x14, mi
        cneg x10, x10, mi
        cmp x11, xzr
        ...
        stp x0, x1, [sp, #96]
        stp x3, x2, [sp, #112]
Lrscrypto_edwards25519_scalarmuldouble_alt_invmidloop:
        mov x1, x22
        ldr x2, [sp]
        ldr x3, [sp, #32]
        and x4, x2, #0xfffff
        ...
        mov x22, x1
        subs x21, x21, #0x1
        b.ne Lrscrypto_edwards25519_scalarmuldouble_alt_invloop
        ldr x0, [sp]
        ldr x1, [sp, #32]
        mul x0, x0, x10
        madd x1, x1, x11, x0
        ...
        ldp x19, x20, [sp], #16 ; .cfi_adjust_cfa_offset -16 ; .cfi_restore x19 ; .cfi_restore x20
        ret ; .cfi_endproc
.size rscrypto_edwards25519_scalarmuldouble_alt, .-rscrypto_edwards25519_scalarmuldouble_alt
.type Lrscrypto_edwards25519_scalarmuldouble_alt_epdouble, %function
Lrscrypto_edwards25519_scalarmuldouble_alt_epdouble:
        .cfi_startproc
        ...
        ret ; .cfi_endproc
.size Lrscrypto_edwards25519_scalarmuldouble_alt_epdouble, .-Lrscrypto_edwards25519_scalarmuldouble_alt_epdouble
.type Lrscrypto_edwards25519_scalarmuldouble_alt_pdouble, %function
Lrscrypto_edwards25519_scalarmuldouble_alt_pdouble:
        .cfi_startproc
        sub sp, sp, #(5*32 +0) ; .cfi_adjust_cfa_offset 5*32
        ldp x3, x4, [x23, #0] ; ldp x7, x8, [x23, #32] ; adds x3, x3, x7 ; adcs x4, x4, x8 ; ldp x5, x6, [x23, #0 +16] ; ldp x7, x8, [x23, #32 +16] ; adcs x5, x5, x7 ; adcs x6, x6, x8 ; mov x9, #38 ; csel x9, x9, xzr, cs ; adds x3, x3, x9 ; adcs x4, x4, xzr ; adcs x5, x5, xzr ; adc x6, x6, xzr ; stp x3, x4, [sp, #(0*32)] ; stp x5, x6, [sp, #(0*32)+16]
        ldp x2, x3, [x23, #(2*32)] ; mul x9, x2, x3 ; umulh x10, x2, x3 ; ldp x4, x5, [x23, #(2*32)+16] ; mul x11, x2, x5 ; umulh x12, x2, x5 ; mul x7, x2, x4 ; umulh x6, x2, x4 ; adds x10, x10, x7 ; adcs x11, x11, x6 ; mul x7, x3, x4 ; umulh x6, x3, x4 ; adc x6, x6, xzr ; adds x11, x11, x7 ; mul x13, x4, x5 ; umulh x14, x4, x5 ; adcs x12, x12, x6 ; mul x7, x3, x5 ; umulh x6, x3, x5 ; adc x6, x6, xzr ; adds x12, x12, x7 ; adcs x13, x13, x6 ; adc x14, x14, xzr ; adds x9, x9, x9 ; adcs x10, x10, x10 ; adcs x11, x11, x11 ; adcs x12, x12, x12 ; adcs x13, x13, x13 ; adcs x14, x14, x14 ; cset x6, cs ; umulh x7, x2, x2 ; mul x8, x2, x2 ; adds x9, x9, x7 ; mul x7, x3, x3 ; adcs x10, x10, x7 ; umulh x7, x3, x3 ; adcs x11, x11, x7 ; mul x7, x4, x4 ; adcs x12, x12, x7 ; umulh x7, x4, x4 ; adcs x13, x13, x7 ; mul x7, x5, x5 ; adcs x14, x14, x7 ; umulh x7, x5, x5 ; adc x6, x6, x7 ; mov x3, #0x26 ; mul x7, x3, x12 ; umulh x4, x3, x12 ; adds x8, x8, x7 ; mul x7, x3, x13 ; umulh x13, x3, x13 ; adcs x9, x9, x7 ; mul x7, x3, x14 ; umulh x14, x3, x14 ; adcs x10, x10, x7 ; mul x7, x3, x6 ; umulh x6, x3, x6 ; adcs x11, x11, x7 ; cset x12, cs ; adds x11, x11, x14 ; adc x12, x12, x6 ; cmn x11, x11 ; bic x11, x11, #0x8000000000000000 ; adc x2, x12, x12 ; mov x3, #0x13 ; mul x7, x3, x2 ; adds x8, x8, x7 ; adcs x9, x9, x4 ; adcs x10, x10, x13 ; adc x11, x11, xzr ; stp x8, x9, [sp, #(1*32)] ; stp x10, x11, [sp, #(1*32)+16]
        ...
        add sp, sp, #(5*32 +0) ; .cfi_adjust_cfa_offset -5*32
        ret ; .cfi_endproc
.size Lrscrypto_edwards25519_scalarmuldouble_alt_pdouble, .-Lrscrypto_edwards25519_scalarmuldouble_alt_pdouble
.type Lrscrypto_edwards25519_scalarmuldouble_alt_epadd, %function
Lrscrypto_edwards25519_scalarmuldouble_alt_epadd:
        .cfi_startproc
        ...
        ret ; .cfi_endproc
.size Lrscrypto_edwards25519_scalarmuldouble_alt_epadd, .-Lrscrypto_edwards25519_scalarmuldouble_alt_epadd
.type Lrscrypto_edwards25519_scalarmuldouble_alt_pepadd, %function
Lrscrypto_edwards25519_scalarmuldouble_alt_pepadd:
        .cfi_startproc
        sub sp, sp, #(6*32 +0) ; .cfi_adjust_cfa_offset 6*32
        ...
        add sp, sp, #(6*32 +0) ; .cfi_adjust_cfa_offset -6*32
        ret ; .cfi_endproc
.size Lrscrypto_edwards25519_scalarmuldouble_alt_pepadd, .-Lrscrypto_edwards25519_scalarmuldouble_alt_pepadd
.section .note.GNU-stack, "", %progbits
.section .rodata
.type rscrypto_edwards25519_scalarmuldouble_alt_constant, %object
.size rscrypto_edwards25519_scalarmuldouble_alt_constant, 768
rscrypto_edwards25519_scalarmuldouble_alt_constant:
