...
// - edwards25519_scalarmulbase.S
//
// The public symbol is renamed to the rscrypto namespace and embedded with Rust global_asm!.


 .globl rscrypto_edwards25519_scalarmulbase
        .type rscrypto_edwards25519_scalarmulbase, %function
        .hidden rscrypto_edwards25519_scalarmulbase
        .text
rscrypto_edwards25519_scalarmulbase:
        .cfi_startproc
        ...
        btr $59, %r11
        movq %r11, 0 +24(%rsp)
        leaq Lrscrypto_edwards25519_scalarmulbase_0g(%rip), %r10
        leaq Lrscrypto_edwards25519_scalarmulbase_251g(%rip), %r11
        movq (%r10), %rax
        movq (%r11), %rcx
        cmovcq %rcx, %rax
        movq %rax, (10*32)(%rsp)
        ...
        movq $0, 14*32 +8(%rsp)
        leaq Lrscrypto_edwards25519_scalarmulbase_gtable(%rip), %rax
        movq %rax, 15*32(%rsp)
        movq $0, 14*32 +16(%rsp)
Lrscrypto_edwards25519_scalarmulbase_scalarloop:
        ...
        jc Lrscrypto_edwards25519_scalarmulbase_scalarloop
        movq (10*32)(%rsp), %r8
        movq (10*32)+8(%rsp), %r9
        ...
        movq $0xa, 0x90(%rsp)
        movq $0x1, 0x98(%rsp)
        jmp Lrscrypto_edwards25519_scalarmulbase_midloop
Lrscrypto_edwards25519_scalarmulbase_inverseloop:
        movq %r8, %r9
        sarq $0x3f, %r9
        xorq %r9, %r8
        subq %r9, %r8
        ...
        addq %rax, %rsi
        movq %rsi, 0x78(%rsp)
Lrscrypto_edwards25519_scalarmulbase_midloop:
        movq 0x98(%rsp), %rsi
        movq (%rsp), %rdx
        movq 0x20(%rsp), %rcx
        movq %rdx, %rbx
        ...
        movq %rsi, 0x98(%rsp)
        decq 0x90(%rsp)
        jne Lrscrypto_edwards25519_scalarmulbase_inverseloop
        movq (%rsp), %rax
        movq 0x20(%rsp), %rcx
        imulq %r8, %rax
        imulq %r10, %rcx
        ...
        retq ; .cfi_endproc
.size rscrypto_edwards25519_scalarmulbase, .-rscrypto_edwards25519_scalarmulbase
Lrscrypto_edwards25519_scalarmulbase_0g:
        ...
        .quad 0x0000000000000000
        .quad 0x0000000000000000
Lrscrypto_edwards25519_scalarmulbase_251g:
...
Lrscrypto_edwards25519_scalarmulbase_gtable:
