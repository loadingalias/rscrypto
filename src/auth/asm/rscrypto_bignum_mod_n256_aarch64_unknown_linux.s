...
// The public symbol is renamed to the rscrypto namespace and embedded with Rust global_asm!.
        ...
        .globl rscrypto_bignum_mod_n256_alt

        .hidden rscrypto_bignum_mod_n256_alt
        .text
        .balign 4
rscrypto_bignum_mod_n256:

rscrypto_bignum_mod_n256_alt:
        .cfi_startproc
        ...
        movz x12, #0xdaaf
        movk x12, #0x039c, lsl #16
        movk x12, #0x353d, lsl #32
        movk x12, #0x0c46, lsl #48
        movz x13, #0x617b
        movk x13, #0x58e8, lsl #16
        movk x13, #0x0552, lsl #32
        movk x13, #0x4319, lsl #48
