...
// The public symbol is renamed to the rscrypto namespace and embedded with Rust global_asm!.
        ...
        .globl rscrypto_bignum_tomont_p256

        .hidden rscrypto_bignum_tomont_p256
        .globl rscrypto_bignum_tomont_p256_alt

        .hidden rscrypto_bignum_tomont_p256_alt
        .text
        .balign 4
rscrypto_bignum_tomont_p256:

rscrypto_bignum_tomont_p256_alt:
        .cfi_startproc
