...
// The public symbol is renamed to the rscrypto namespace and embedded with Rust global_asm!.
        ...
        .globl _rscrypto_p256_scalarmulbase_alt

        .private_extern _rscrypto_p256_scalarmulbase_alt


        .text
        .balign 4
_rscrypto_p256_scalarmulbase_alt:
        .cfi_startproc
        ...
        sub sp, sp, #(9*32 +0) %% .cfi_adjust_cfa_offset 9*32
