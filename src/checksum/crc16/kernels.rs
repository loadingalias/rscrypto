...
pub(in crate::checksum) mod x86_64 {
  ...
  /// CCITT PCLMUL kernel.
  pub(in crate::checksum) const CCITT_PCLMUL: [Crc16Fn; 5] = [
  ...
  pub(in crate::checksum) const CCITT_PCLMUL_SMALL_KERNEL: Crc16Fn = arch::crc16_ccitt_pclmul_small_safe;

  /// CCITT VPCLMUL kernel.
  pub(in crate::checksum) const CCITT_VPCLMUL: [Crc16Fn; 5] = [
  ...
  /// IBM PCLMUL kernel.
  pub(in crate::checksum) const IBM_PCLMUL: [Crc16Fn; 5] = [
  ...
  pub(in crate::checksum) const IBM_PCLMUL_SMALL_KERNEL: Crc16Fn = arch::crc16_ibm_pclmul_small_safe;

  /// IBM VPCLMUL kernel.
  pub(in crate::checksum) const IBM_VPCLMUL: [Crc16Fn; 5] = [
...
pub(in crate::checksum) mod aarch64 {
  ...
  pub(in crate::checksum) const CCITT_PMULL: [Crc16Fn; 5] = [
  ...
  pub(in crate::checksum) const CCITT_PMULL_EOR3: [Crc16Fn; 5] = [
  ...
  pub(in crate::checksum) const CCITT_PMULL_SMALL_KERNEL: Crc16Fn = arch::crc16_ccitt_pmull_small_safe;

  // CRC-16/IBM Kernel Functions

  /// IBM PMULL kernels: [1-way, 2-way, 3-way, 3-way(dup), 3-way(dup)].
  pub(in crate::checksum) const IBM_PMULL: [Crc16Fn; 5] = [
  ...
  #[cfg(all(feature = "std", not(miri), any(target_os = "linux", target_os = "android")))]
  pub(in crate::checksum) const IBM_PMULL_EOR3: [Crc16Fn; 5] = [
  ...
  pub(in crate::checksum) const IBM_PMULL_SMALL_KERNEL: Crc16Fn = arch::crc16_ibm_pmull_small_safe;
}
...
pub(in crate::checksum) mod power {
  ...
  pub(in crate::checksum) const CCITT_VPMSUM: [Crc16Fn; 5] = [
  ...
  pub(in crate::checksum) const IBM_VPMSUM: [Crc16Fn; 5] = [
...
pub(in crate::checksum) mod s390x {
  ...
  pub(in crate::checksum) const CCITT_VGFM: [Crc16Fn; 5] = [
  ...
  pub(in crate::checksum) const IBM_VGFM: [Crc16Fn; 5] = [
...
pub(in crate::checksum) mod riscv64 {
  ...
  pub(in crate::checksum) const CCITT_ZBC: [Crc16Fn; 5] = [
  ...
  pub(in crate::checksum) const CCITT_ZVBC: [Crc16Fn; 5] = [
  ...
  pub(in crate::checksum) const IBM_ZBC: [Crc16Fn; 5] = [
  ...
  pub(in crate::checksum) const IBM_ZVBC: [Crc16Fn; 5] = [
