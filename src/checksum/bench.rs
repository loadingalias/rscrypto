...
use crate::checksum::dispatchers::{Crc16Fn, Crc24Fn, Crc32Fn, Crc64Fn};
...
pub fn available_crc16_kernels() -> Vec<&'static str> {
  ...
  {
    use crate::checksum::crc16::kernels::x86_64;
  ...
  {
    use crate::checksum::crc16::kernels::aarch64;
    let caps = crate::platform::caps();
  ...
  {
    use crate::checksum::crc16::kernels::power;
    let caps = crate::platform::caps();
  ...
  {
    use crate::checksum::crc16::kernels::s390x;
    let caps = crate::platform::caps();
  ...
  {
    use crate::{checksum::crc16::kernels::riscv64, platform::caps::riscv};
    let caps = crate::platform::caps();
...
pub fn get_crc16_ccitt_kernel(name: &str) -> Option<Crc16Kernel> {
  use crate::checksum::common::{reference::crc16_bitwise, tables::CRC16_CCITT_POLY};
  ...
  if name == "portable" || name == "portable/slice4" {
    return Some(Crc16Kernel {
      ...
      func: crate::checksum::crc16::portable::crc16_ccitt_slice4,
    });
  }
  if name == "portable/slice8" {
    return Some(Crc16Kernel {
      name: "portable/slice8",
      func: crate::checksum::crc16::portable::crc16_ccitt_slice8,
    });
  }
...
pub fn get_crc16_ibm_kernel(name: &str) -> Option<Crc16Kernel> {
  use crate::checksum::common::{reference::crc16_bitwise, tables::CRC16_IBM_POLY};
  ...
  if name == "portable" || name == "portable/slice4" {
    return Some(Crc16Kernel {
      name: "portable/slice4",
      func: crate::checksum::crc16::portable::crc16_ibm_slice4,
    });
  }
  if name == "portable/slice8" {
    return Some(Crc16Kernel {
      name: "portable/slice8",
      func: crate::checksum::crc16::portable::crc16_ibm_slice8,
    });
  }
...
pub fn available_crc24_kernels() -> Vec<&'static str> {
  ...
  #[cfg(target_arch = "x86_64")]
  {
    use crate::checksum::crc24::kernels::x86_64;
    let caps = crate::platform::caps();
  ...
  #[cfg(target_arch = "aarch64")]
  {
    use crate::checksum::crc24::kernels::aarch64;
    let caps = crate::platform::caps();
  ...
  #[cfg(target_arch = "powerpc64")]
  {
    use crate::checksum::crc24::kernels::power;
    let caps = crate::platform::caps();
  ...
  #[cfg(target_arch = "s390x")]
  {
    use crate::checksum::crc24::kernels::s390x;
    let caps = crate::platform::caps();
  ...
  #[cfg(target_arch = "riscv64")]
  {
    use crate::{checksum::crc24::kernels::riscv64, platform::caps::riscv};
    let caps = crate::platform::caps();
...
pub fn get_crc24_openpgp_kernel(name: &str) -> Option<Crc24Kernel> {
  use crate::checksum::common::{reference::crc24_bitwise, tables::CRC24_OPENPGP_POLY};
  ...
  if name == "portable" || name == "portable/slice4" {
    return Some(Crc24Kernel {
      name: "portable/slice4",
      func: crate::checksum::crc24::portable::crc24_openpgp_slice4,
    });
  }
  if name == "portable/slice8" {
    return Some(Crc24Kernel {
      name: "portable/slice8",
      func: crate::checksum::crc24::portable::crc24_openpgp_slice8,
    });
  }
...
pub fn available_crc32_ieee_kernels() -> Vec<&'static str> {
  ...
  #[cfg(target_arch = "x86_64")]
  {
    use crate::checksum::crc32::kernels::x86_64;
    let caps = crate::platform::caps();
  ...
  #[cfg(target_arch = "aarch64")]
  {
    use crate::checksum::crc32::kernels::aarch64;
    let caps = crate::platform::caps();
    ...
    if caps.has(crate::platform::caps::aarch64::PMULL_READY) && caps.has(crate::platform::caps::aarch64::CRC_READY) {
      kernels.extend_from_slice(aarch64::CRC32_PMULL_NAMES);
      kernels.push(aarch64::PMULL_SMALL);
    }
    if caps.has(crate::platform::caps::aarch64::PMULL_EOR3_READY) && caps.has(crate::platform::caps::aarch64::CRC_READY)
    {
      kernels.extend_from_slice(aarch64::CRC32_PMULL_EOR3_NAMES);
    }
    if caps.has(crate::platform::caps::aarch64::SVE2_PMULL)
      && caps.has(crate::platform::caps::aarch64::PMULL_READY)
      && caps.has(crate::platform::caps::aarch64::CRC_READY)
    {
  ...
  #[cfg(target_arch = "powerpc64")]
  {
    use crate::checksum::crc32::kernels::power;
    let caps = crate::platform::caps();
  ...
  #[cfg(target_arch = "s390x")]
  {
    use crate::checksum::crc32::kernels::s390x;
    let caps = crate::platform::caps();
  ...
  #[cfg(target_arch = "riscv64")]
  {
    use crate::checksum::crc32::kernels::riscv64;
    let caps = crate::platform::caps();
...
pub fn available_crc32c_kernels() -> Vec<&'static str> {
  ...
  #[cfg(target_arch = "x86_64")]
  {
    ...
    if caps.has(crate::platform::caps::x86::CRC32C_READY) && caps.has(crate::platform::caps::x86::PCLMUL_READY) {
      kernels.extend_from_slice(x86_64::CRC32C_FUSION_SSE_NAMES);
    }
    if caps.has(crate::platform::caps::x86::AVX512F) && caps.has(crate::platform::caps::x86::PCLMUL_READY) {
...
pub fn get_crc32_ieee_kernel(name: &str) -> Option<Crc32Kernel> {
  use crate::checksum::common::{reference::crc32_bitwise, tables::CRC32_IEEE_POLY};
  ...
  if name == "portable" || name == "portable/slice16" {
    return Some(Crc32Kernel {
      ...
      func: crate::checksum::crc32::portable::crc32_slice16_ieee,
    });
  }
  if name == "portable/bytewise" {
    return Some(Crc32Kernel {
      name: "portable/bytewise",
      func: crate::checksum::crc32::portable::crc32_bytewise_ieee,
    });
  }
...
pub fn get_crc32c_kernel(name: &str) -> Option<Crc32Kernel> {
  use crate::checksum::common::{reference::crc32_bitwise, tables::CRC32C_POLY};
  ...
  if name == "portable" || name == "portable/slice16" {
    return Some(Crc32Kernel {
      name: "portable/slice16",
      func: crate::checksum::crc32::portable::crc32c_slice16,
    });
  }
  if name == "portable/bytewise" {
    return Some(Crc32Kernel {
      name: "portable/bytewise",
      func: crate::checksum::crc32::portable::crc32c_bytewise,
    });
  }
...
pub fn available_crc64_kernels() -> Vec<&'static str> {
  ...
  #[cfg(target_arch = "x86_64")]
  {
    use crate::checksum::crc64::kernels::x86_64::*;
    let caps = crate::platform::caps();
  ...
  #[cfg(target_arch = "aarch64")]
  {
    use crate::checksum::crc64::kernels::aarch64::*;
    let caps = crate::platform::caps();
  ...
  #[cfg(target_arch = "powerpc64")]
  {
    use crate::checksum::crc64::kernels::power::*;
    let caps = crate::platform::caps();
  ...
  #[cfg(target_arch = "s390x")]
  {
    use crate::checksum::crc64::kernels::s390x::*;
    let caps = crate::platform::caps();
  ...
  #[cfg(target_arch = "riscv64")]
  {
    use crate::checksum::crc64::kernels::riscv64::*;
    let caps = crate::platform::caps();
...
pub fn get_crc64_xz_kernel(name: &str) -> Option<Crc64Kernel> {
  use crate::checksum::common::{reference::crc64_bitwise, tables::CRC64_XZ_POLY};
  ...
  if name == "portable" || name == "portable/slice16" {
    return Some(Crc64Kernel {
      name: "portable/slice16",
      func: crate::checksum::crc64::portable::crc64_slice16_xz,
    });
  }
...
pub fn get_crc64_nvme_kernel(name: &str) -> Option<Crc64Kernel> {
  use crate::checksum::common::{reference::crc64_bitwise, tables::CRC64_NVME_POLY};
  ...
  if name == "portable" || name == "portable/slice16" {
    return Some(Crc64Kernel {
      name: "portable/slice16",
      func: crate::checksum::crc64::portable::crc64_slice16_nvme,
    });
  }
