...
fn run_x86_64_kernels_castagnoli(data: &[u8], results: &mut alloc::vec::Vec<KernelResult>) {
  ...
  if caps.has(crate::platform::caps::x86::CRC32C_READY) && caps.has(crate::platform::caps::x86::AVX512_READY) {
    run_kernel_array(data, &CRC32C_FUSION_AVX512, CRC32C_FUSION_AVX512_NAMES, results);
  }

  // Fusion (AVX-512 + VPCLMUL) kernels
  if caps.has(crate::platform::caps::x86::CRC32C_READY) && caps.has(crate::platform::caps::x86::VPCLMUL_READY) {
