...
#[cfg(any(test, feature = "testing"))]
#[inline]
pub(crate) fn slice4_24(crc: u32, data: &[u8], tables: &[[u32; 256]; 4]) -> u32 {
...
mod tests {
  ...
  fn test_slice4_24_empty() {
    let tables =
      crate::checksum::common::tables::generate_crc24_tables_4(crate::checksum::common::tables::CRC24_OPENPGP_POLY);
  ...
  fn test_slice4_24_matches_slice8_24() {
    let poly = crate::checksum::common::tables::CRC24_OPENPGP_POLY;
    let tables4 = crate::checksum::common::tables::generate_crc24_tables_4(poly);
    let tables8 = crate::checksum::common::tables::generate_crc24_tables_8(poly);
    let data = b"The quick brown fox jumps over the lazy dog";
