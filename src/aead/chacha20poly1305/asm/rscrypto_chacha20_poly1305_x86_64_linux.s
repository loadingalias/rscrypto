...
//
// Adapted for rscrypto from the generated AWS-LC/BoringSSL x86_64
// ChaCha20-Poly1305 assembly. Symbols are namespaced to avoid collisions,
// C preprocessor directives are removed for Rust `global_asm!`, and the
// OpenSSL CPU capability word is replaced with a local AVX2+BMI2 selector.
// Rust dispatch must gate calls on x86_64 AVX2 and BMI2.


.text	

rscrypto_chacha20_poly1305_constants_x86_64:

.section	.rodata
.align	16
rscrypto_chacha20_poly1305_x86_64_caps:
.long	0,0,288,0
.align	64
.Lchacha20_consts:
...
.type	rscrypto_chacha20_poly1305_poly_hash_ad_internal_x86_64,@function
.align	64
rscrypto_chacha20_poly1305_poly_hash_ad_internal_x86_64:
.cfi_startproc	
.cfi_def_cfa	rsp, 8
	xorq	%r10,%r10
	xorq	%r11,%r11
...
.Lhash_ad_done:
	.byte	0xf3,0xc3
.cfi_endproc	
.size	rscrypto_chacha20_poly1305_poly_hash_ad_internal_x86_64, .-rscrypto_chacha20_poly1305_poly_hash_ad_internal_x86_64

.globl	rscrypto_chacha20_poly1305_open_x86_64
.hidden rscrypto_chacha20_poly1305_open_x86_64
.type	rscrypto_chacha20_poly1305_open_x86_64,@function
.align	64
...
.cfi_adjust_cfa_offset	288 + 32
	...
	movl	rscrypto_chacha20_poly1305_x86_64_caps+8(%rip),%eax
	andl	$288,%eax
	xorl	$288,%eax
	jz	rscrypto_chacha20_poly1305_open_avx2_x86_64
...
.byte	102,69,15,58,15,228,4
	...
	movq	%r8,%r8
	call	rscrypto_chacha20_poly1305_poly_hash_ad_internal_x86_64
.Lopen_sse_main_loop:
	cmpq	$256,%rbx
	jb	.Lopen_sse_tail
...
.size	rscrypto_chacha20_poly1305_open_x86_64, .-rscrypto_chacha20_poly1305_open_x86_64
.cfi_endproc	
...
.globl	rscrypto_chacha20_poly1305_seal_x86_64
.hidden rscrypto_chacha20_poly1305_seal_x86_64
.type	rscrypto_chacha20_poly1305_seal_x86_64,@function
.align	64
...
.cfi_adjust_cfa_offset	288 + 32
	...
	andl	$288,%eax
	xorl	$288,%eax
	jz	rscrypto_chacha20_poly1305_seal_avx2_x86_64
...
.byte	102,69,15,58,15,246,4
	...
	call	rscrypto_chacha20_poly1305_poly_hash_ad_internal_x86_64
	jmp	.Lseal_sse_128_tail_xor
.size	rscrypto_chacha20_poly1305_seal_x86_64, .-rscrypto_chacha20_poly1305_seal_x86_64
.cfi_endproc	


.type	rscrypto_chacha20_poly1305_open_avx2_x86_64,@function
.align	64
rscrypto_chacha20_poly1305_open_avx2_x86_64:
.cfi_startproc	
...
.size	rscrypto_chacha20_poly1305_open_avx2_x86_64, .-rscrypto_chacha20_poly1305_open_avx2_x86_64
.cfi_endproc	


.type	rscrypto_chacha20_poly1305_seal_avx2_x86_64,@function
.align	64
rscrypto_chacha20_poly1305_seal_avx2_x86_64:
.cfi_startproc	
...
.cfi_endproc	
.size	rscrypto_chacha20_poly1305_seal_avx2_x86_64, .-rscrypto_chacha20_poly1305_seal_avx2_x86_64
