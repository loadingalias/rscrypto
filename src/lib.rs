...
//!
//! The full FIPS boundary matrix and roadmap are documented in `private/tasks/fips.md`.
//!
//! # Examples
//!
...
// riscv64 full-feature builds still need nightly target-feature flags, portable
// SIMD, and scalar/vector crypto intrinsics.
#![cfg_attr(
  target_arch = "riscv64",
