...
def hardware() -> dict:
  ...
  if platform.system() == "Darwin":
    ...
    fields = {"vendor_id", "model name", "cpu family", "model", "stepping", "siblings", "cpu cores",
              "Features", "flags", "CPU architecture", "CPU implementer", "CPU part", "machine", "processor",
              "cpu", "revision", "platform"}
