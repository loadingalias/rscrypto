...
**Current Benchmark Evidence:** `1.59x` geomean across the Linux runners vs the fastest-external competitors with `4,040 / 6,750` wins and `6,047 / 6,750` wins-or-ties.

macOS Apple Silicon local evidence: `1.37x` geomean vs fastest-external competitors with `372 / 786` wins and `738 / 786` wins-or-ties.
...
| Linux Scorecard | Fastest External | **4,040 wins / 6,750 Pairs** |
| Linux Wins or Ties | Fastest External | **6,047 / 6,750 Pairs** |
| Linux All Matched Pairs | Every Comparison Row | **1.75x Geomean; 9,911 / 10,781 Wins or Ties** |
| macOS Apple Silicon vs Fastest External | Local Apple Silicon Run | **1.37x Geomean; 738 / 786 Wins or Ties** |
| macOS Apple Silicon All Matched Pairs | Every Comparison Row | **1.65x Geomean; 1,250 / 1,309 Wins or Ties** |
...
| Public-key | Linux, including ML-KEM | **1.32x Geomean** |
| ML-KEM-512/768/1024 | Linux keygen/encapsulate/decapsulate | **1.45x Geomean** |
| ECDSA P-256/P-384 | Linux | **1.45x Geomean** |
| RSA import + verify | Linux | **1.55x Geomean** |
| AEAD | Linux | **1.54x Geomean** |
