...
fuzz_target!(|data: &[u8]| {
    ...
    assert_digest_chunked::<Blake2b256>(data, split);
    assert_digest_chunked::<Blake2b512>(data, split);
    assert_digest_reset::<Blake2b256>(data);
    assert_digest_reset::<Blake2b512>(data);

    let ours_256 = Blake2b256::digest(data);
    let oracle_256 = OracleBlake2b256::digest(data);
    assert_eq!(&ours_256[..], oracle_256.as_slice(), "blake2b256 mismatch");

    let ours_512 = Blake2b512::digest(data);
    let oracle_512 = OracleBlake2b512::digest(data);
    assert_eq!(&ours_512[..], oracle_512.as_slice(), "blake2b512 mismatch");
    ...
    if !data.is_empty() {
        ...
        let mut ours_256_stream = Blake2b256::keyed(key);
        ...
        let mut ours_512_stream = Blake2b512::keyed(key);
